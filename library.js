...
export function create_3D_button(canvas_id,caller,width,height,rotation_x,rotation_y,rotation_z,color,text) {
    ...
    objects_material[canvas_id] = {}

    const geometry = new THREE.BoxGeometry( 1, 1, 1 );
    const material = new THREE.MeshBasicMaterial( { color: 0x00ff00 } );
    objects_material[canvas_id].object = new THREE.Mesh( geometry, material );
    scene.add( objects_material[canvas_id].object );
    ...
    animates_handlers[canvas_id].animate = function () {
	    ...
	    objects_material[canvas_id].object.rotation.x += 0.01;
	    objects_material[canvas_id].object.rotation.y += 0.01;
